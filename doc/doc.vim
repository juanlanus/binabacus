...
set shortmess=aoO
badd +1 binabacus/doc/tutorial.html
badd +1 binabacus/doc/res/doc.css
badd +0 binabacus/src/jquery.binabacus.js
badd +0 binabacus/doc/code.html
args binabacus/doc/tutorial.html
edit binabacus/doc/tutorial.html
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 125 - ((8 * winheight(0) + 21) / 43)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
125
normal! 041|
tabedit binabacus/src/jquery.binabacus.js
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
